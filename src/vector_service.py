...
QUERY_EXPANSIONS = {
    ...
    "head hurts": "headache migraine nausea visual disturbances",
    "bright light": "light sensitivity photophobia visual disturbances migraine headache",
    "nauseous": "nausea vomiting migraine",
    ...
    "burns when i pee": "burning micturition bladder discomfort urinary tract infection",
    "when i pee": "burning micturition bladder discomfort urinary tract infection",
